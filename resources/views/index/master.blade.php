...
@section('content')
    <div class="container py-1">
        ...
        <ol class="task-list">
            <li>Реализовать сущности авторы и книги <span class="text-muted">Прим.: отношение - many-to-many</span></li>
        ...
        Желательно, в репозиторий залить пустой каркас приложения, а затем с внесёнными изменениями, чтобы можно было проследить diff.</p>
    </div>
@endsection
